      ...
      <main className="w-full max-w-md z-10 flex flex-col gap-8">
        ...
        <header className="flex flex-col items-center text-center gap-4">
          <div className="relative">
            <div className="w-20 h-20 bg-primary-container rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(0,87,255,0.4)] rotate-3 hover:rotate-0 transition-transform duration-500">
              <img 
                src="/icon.svg" 
                alt="Logo" 
